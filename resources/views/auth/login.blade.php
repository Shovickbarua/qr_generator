                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-primary bg-green-700">
                                    {{ __('Login') }}
                                </button>
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="/"
         class="mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img class="h-12 mr-2" src="{{asset('img/flexqr-logo.png')}}" alt="logo">
        </a>
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div>
                        ...
                        @error('email')
                            <span class="invalid-feedback text-rose-600" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a class="text-sm font-medium text-primary-600 text-white hover:underline dark:text-primary-500" href="{{ route('password.request') }}">
                                {{ __('Forgot Your Password?') }}
                            </a>
                        @endif
                    </div>
                    ...
                    <a href="{{route('google-auth')}}" > <img src="/img/googlelogo.png" class=" mx-auto mt-5 h-10 w-auto " alt=""></a>
                 ...
                 <div class=" flex justify-center items-center ">  <button class="py-1 px-4 bg-blue-500  text-white text-center font-semibold rounded"> <a href="/"> Back Home Page</a></button></div>
                </form>
            </div>
        </div>
    </div>
