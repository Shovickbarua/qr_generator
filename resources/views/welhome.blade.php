...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
    ...
    <div class="flex md:order-2">
       ...
       <div>
        <button type="button" href="/login" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Signup</button>
        </div> 
...
<div>
    <h1 class=" pt-36 text-center font-bold font-sans text-6xl ">Create your own <a class=" text-blue-800">QR codes</a> and <br> boost your business or idea.</h1>
</div>
<div>
    <h4 class=" text-center text-xl pt-6">Easily generate, manage and statistically track your QR codes.</h4>
</div>
<div class=" mt-10 text-center">
    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-3xl text-3xl px-12 py-4 mr-3 md:mr-0 ">Create QR code</button>
</div>
<div class=" mt-5 relative ">
    <img src=" /img/hero_image.png" alt="">
</div>
<div class=" mt-20 text-center"> 
    <h2 class=" text-4xl">Everything you need to know to get started</h2>
    <h4 class=" text-xl mt-2">In this section you will find the basic concepts and the necessary steps to start enjoying the benefits of using QR.</h4>
</div> 
<div class="flex">
    <div>
        <img src=" /img/qrpic.png" alt="">
    </div>
    <div>
